...
export function Beyond() {
  return (
    <Section labelledBy="beyond-heading" background={backgrounds.beyond} position="center right">
      <div className="shell">
        <SectionHeader index="07 ? Beyond the lab" title="Beyond the lab" id="beyond-heading" description="Community work, citizen science, and competitive play that keeps the research grounded." />
